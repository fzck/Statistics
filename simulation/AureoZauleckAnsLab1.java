...
public class AureoZauleckAnsLab1{
 ...
 // public static void main(String[] args) {
        ...
        do{
            ...
            if(choice == 1){  
                ...
                for(int i = 0,j=1; i < all.size(); i++){
                    ...
                    System.out.println("SRS from stratum:");
                    SRS(all.get(i));  
                    System.out.println();
                }    
                System.out.println();
    ...
    public static void Systematic(ArrayList sampleframe){               
        ...
        ArrayList<Integer> samplesI = new ArrayList<Integer>();    
        ...
        System.out.println("These are the chosen samples:");
        for(int i = 0; i < samplesI.size(); i++){
            int ii = samplesI.get(i)+1 ;
            System.out.println(samples.get(i)+" from index ["+ ii+"] ");
        }
